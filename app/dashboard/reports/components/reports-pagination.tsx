...
import type { ReportsData } from "@/lib/api/reports.api";

interface ReportsPaginationBarProps {
...
export const ReportsPaginationBar = ({
  data,
  page,
  limit,
  onPageChange,
  onLimitChange,
}: ReportsPaginationBarProps) => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border bg-card px-4 py-3 mt-4">
